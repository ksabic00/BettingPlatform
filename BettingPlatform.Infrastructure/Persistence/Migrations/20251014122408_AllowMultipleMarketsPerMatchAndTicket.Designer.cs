...
namespace BettingPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251014122408_AllowMultipleMarketsPerMatchAndTicket")]
    partial class AllowMultipleMarketsPerMatchAndTicket
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BettingPlatform.Domain.Entities.Offer", b =>
                {
                    ...
                    b.HasIndex("MatchId", "MarketTemplateId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BettingPlatform.Domain.Entities.OfferOutcome", b =>
                {
                    ...
                    b.HasIndex("OfferId", "OutcomeTemplateId")
                        .IsUnique();
